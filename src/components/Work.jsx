...
export default function Work() {
    ...
    const workTitle = ["Designing Dashboard", "Vibrant Portraits of 2020", "36 Days of Malayalam Type", "Components"];
    const workYears = [2020, 2018, 2018, 2018];
    const workTypes = ["Dashboard", "Illustration", "Typography", "Components, Design"];
